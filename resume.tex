...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Brian}{Voskerijian}
\address{1604 Monroe Street Endicott, NY 13760}
\mobile{(516) 770 8192} 
%%% Social
\email{bvoskerijian@gmail.com}
%\homepage{}
%\github{posquit0}
%\linkedin{posquit0}
%%% Optionals
\position{Firmware Engineer}
%\quote{A driven engineer ready to embrace software craftsmanship}
